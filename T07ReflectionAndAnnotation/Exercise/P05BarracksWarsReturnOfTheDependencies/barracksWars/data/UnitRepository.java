package T07ReflectionAndAnnotation.Exercise.P05BarracksWarsReturnOfTheDependencies.barracksWars.data;
...
public class UnitRepository implements Repository {
	...
	// P04 method implementation:
	public void removeUnit(String unitType)  {
		Integer currentNumber = this.amountOfUnits.get(unitType);
		if (currentNumber == null || currentNumber == 0) {
			throw new IllegalArgumentException("No such units in repository.");
		}

		currentNumber--;
		this.amountOfUnits.put(unitType, currentNumber);
	}
