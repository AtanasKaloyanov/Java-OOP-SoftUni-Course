package T07ReflectionAndAnnotation.Exercise.P04BarracksWarsTheCommandsStrikeBack.barracksWars.core;

import T07ReflectionAndAnnotation.Exercise.P04BarracksWarsTheCommandsStrikeBack.barracksWars.interfaces.*;
...
public class Engine implements Runnable {
	...
	private String interpretCommand(String[] data, String commandName) throws ExecutionControl.NotImplementedException, ClassNotFoundException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
		...
		Executable commandObject = (Executable) constructor.newInstance(data, this.repository, this.unitFactory);
		// 3. Return the result of the execute method:
	...
	private static String getClassSimpleName(String commandName) {
		return "T07ReflectionAndAnnotation.Exercise.P04BarracksWarsTheCommandsStrikeBack.barracksWars.core.commands." +
